...
import { FaBox, FaList, FaChartBar, FaUsers, FaMapMarkerAlt, FaBars, FaTimes } from 'react-icons/fa';
...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: 'Local Customer', path: '/local-customer', icon: <FaUsers className="mr-2" /> },
